...
![Terminal.app](https://raw.github.com/sheepsteak/dotfiles/master/iterm/chris-terminal.png)
...
```sh
sh -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/sheepsteak/dotfiles/master/remote-setup.sh`"
```
